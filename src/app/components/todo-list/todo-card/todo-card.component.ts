...
import { TodoEditEntryFormComponent } from '../todo-edit-entry-form/todo-edit-entry-form.component';



@Component({
    selector: 'app-todo-card',
    imports: [NgFor, NgIf, MatCardModule, MatButtonModule, MatIconModule, MatTabsModule, MatDialogModule],
...
export class TodoCardComponent implements OnInit {
  ...
  public handleOpenModal(todoId: number): void {
  ...
  public handleEditTodo(todoId: number): void {
